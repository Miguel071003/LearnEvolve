...
const preguntas = [
        ...
        //pregunta 6
    {
        ...
        pregunta: `
            ...
            <img src="img1.jpg" style="width:300px; margin:10px 0;"><br>
        ...
        //pregunta 10
    {
        ...
        pregunta: `
            Consulte la ilustración.<br>
            <img src="img2.jpg" style="width:400px; margin:10px 0;"><br>
        ...
        //pregunta 16
    {
        ...
        pregunta: `
            Consulte la ilustración.<br>
            <img src="img3.jpg" style="width:500px; margin:10px 0;"><br>
        ...
        //pregunta 22
    {
        ...
        //pregunta 23
    {
        pregunta: '<img src="img4.jpg" style="width:500px; margin:10px 0;"><br>¿Cuál de las siguientes opciones muestra el emparejamiento correcto de las direcciones IP con su tipo de clasificación?',
        tipo: "simple",
        respuesta: [
        ...
        //pregunta 24
    {
        ...
        pregunta: `
            Consulte la ilustración.<br>
            <img src="img5.jpg" style="width:500px; margin:10px 0;"><br>
    ...
    //pregunta 34
    {
        ...
        pregunta: `
            Consulte la ilustración.<br>
            <img src="img6.jpg" style="width:500px; margin:10px 0;"><br>
            <img src="img7.jpg" style="width:500px; margin:10px 0;"><br>
    ...
    //pregunta 36
    {
        ...
        pregunta: `
            Consulte la ilustración.<br>
            <img src="img8.jpg" style="width:500px; margin:10px 0;"><br>
    ...
    //pregunta 57
    {
        ...
        pregunta: `
            Consulte la ilustración.<br>
            <img src="img9.jpg" style="width:500px; margin:10px 0;"><br>
